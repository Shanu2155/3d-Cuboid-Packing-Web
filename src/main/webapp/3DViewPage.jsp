...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        function scale(o3D,factor){
            for(var i=0;i<o3D.points.length;i++){
                o3D.points[i].x*=factor;
                o3D.points[i].y*=factor;
                o3D.points[i].z*=factor;
            }
        }
        function init(){
...
//             rotate(cube, 'z', 0.3);
    ...
    <body onload="init();">
        <canvas id="3Dcube" width="1500" height="1500"></canvas>
    </body>
</html>
